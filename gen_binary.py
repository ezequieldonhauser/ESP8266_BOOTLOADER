...
def gen_appbin():
	...
	print "------------------------------------------------------------------"
	print " MEMORIA RAM DE USO GERAL (.rodata .bss)"
	print "[SRAM USADO:",sram_usado,"Bytes][SRAM LIVRE:",sram_sobra,"Bytes]"
	print "------------------------------------------------------------------"
	print " MEMORIA DE EXECUCAO RAPIDA (.text)"
	print "[IRAM USADO:",iram_usado,"Bytes][IRAM LIVRE:",iram_sobra,"Bytes]"
	print "=================================================================="
